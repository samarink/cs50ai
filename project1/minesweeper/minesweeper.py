...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        mines_count, neighbors_to_remove = self.get_mines_count_and_neighbors_to_remove(
            count, neighbors)
        neighbors -= neighbors_to_remove

        new_sentence = Sentence(neighbors, mines_count)
    ...
    def get_mines_count_and_neighbors_to_remove(self, count, neighbors):
        mine_count = count
        ...
        return (mine_count, neighbors_to_remove)
    ...
    def add_new_sentence(self, new_sentence):
        knowledge_to_add = []
